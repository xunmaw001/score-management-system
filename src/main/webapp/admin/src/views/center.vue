  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
             <el-form-item v-if="flag=='yonghu'"  label='班级' prop="yonghuTypes">
                 <el-select v-model="ruleForm.yonghuTypes"  placeholder='请选择班级'>
                     <el-option
		 ...
		 <el-col :span="12">
			 <el-form-item v-if="flag=='yonghu'"  class="input" label="生日" prop="shengriTime">
			     <el-date-picker
