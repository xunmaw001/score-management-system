        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="班级" prop="yonghuTypes">
                        <el-select v-model="ruleForm.yonghuTypes" :disabled="ro.yonghuTypes" placeholder="请选择班级">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="班级" prop="yonghuValue">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="生日" prop="shengriTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd"
                                v-model="ruleForm.shengriTime"
                                type="date"
                                placeholder="生日"
                                :disabled="ro.shengriTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.shengriTime" label="生日" prop="shengriTime">
                            <span v-html="ruleForm.shengriTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
