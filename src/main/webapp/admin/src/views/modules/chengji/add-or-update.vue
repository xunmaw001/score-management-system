    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="班级" prop="yonghuValue">
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="详情" prop="chengjiContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.chengjiContent" label="详情" prop="chengjiContent">
